...
# --- 2. CORE ENGINES (CLAUDE 3.5 SONNET) ---
...
def agent_call(messages):
    try:
        ...
        return client.chat.completions.create(
            model="anthropic/claude-3.5-sonnet", # ADAPTIVE LINGUIST BRAIN
            messages=messages,
            stream=True 
        )
...
if prompt:
    ...
    with st.chat_message("assistant"):
        ...
        sys_msg = """
        ROLE: OBITWICEX_JARVIS. Elite Autonomous OS.
        1. GREETING: Always start with 'Assalam o Alaikum, Sir'.
        2. LANGUAGE DETECTION: Identify if the user is using Roman Urdu or English. Respond in the SAME language.
        3. PERSONALITY: Be brief, elite, and professional. 
        4. COMMANDS: Use SEARCH: [query] or EXECUTE: [action] | [target]. 
        5. NEVER explain yourself or give examples unless asked.
        """
